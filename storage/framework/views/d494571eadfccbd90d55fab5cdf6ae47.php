...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
	...
	<body>
		<div class="main">
			...
			<?php endif; ?>
			<form class="input" method="POST" action="<?php echo e(route('product_new_registration_02')); ?>" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<div class="product">
				...
				<div class="company">
					...
					<div class="company_wrap">
						...
						<?php endif; ?>
						<input type="text" name="new_company_name" id="new_company_name" placeholder="新しいメーカー名を入力" value="<?php echo e(old('new_company_name')); ?>" autocomplete="off">
				...
				<div class="input_btn">
					...
					<button class="return_btn" type="button" onclick="location.href='<?php echo e(route('product_list_01')); ?>'">
						戻る
					</button>
				</div>
			</form>
...
<?php /**PATH C:\xampp\htdocs\CyTech_test\resources\views/04_product_new_registration.blade.php ENDPATH**/ ?>