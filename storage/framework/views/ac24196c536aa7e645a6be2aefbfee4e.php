			...
			<div class="edit">
				...
				<div class="comment">
					...
					<div class="comment_wrap">
						<?php echo e($product->comment); ?>

					</div>
				</div>
				<div class="input_btn">
					<button class="edit_btn" type="button" onclick="location.href='<?php echo e(route('product_edit_01', ['id' => $product->id])); ?>'">
						編集
					</button>
...
<?php /**PATH C:\xampp\htdocs\CyTech_test\resources\views/05_product_detail.blade.php ENDPATH**/ ?>